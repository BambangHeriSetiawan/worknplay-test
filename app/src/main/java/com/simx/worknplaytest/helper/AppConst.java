...
public class AppConst {
    ...
    public static final String MOVIE_DB_KEY ="6cb025fee4cbfb787415c63d5fa87583";
    public static final String API_KEY ="api_key";
    public static final String SORT_DESC ="vote_average.desc";
    public static final String SORT_ASC ="vote_average.sortAsc";
